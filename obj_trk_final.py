...
video = cv2.VideoCapture(r"C:\Users\ASHUTOSH ARYAN\OneDrive\Desktop\coding\module 3\project\C---107[OBJECT DETECTION AND TRACKING]\project-C107-template-main\footvolleyball.mp4")
#load tracker 
